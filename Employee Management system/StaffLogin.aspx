<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaffLogin.aspx.cs" Inherits="Employee_Management_system.StaffLogin" %>
    ...
    <form id="form1" runat="server">
        <div class="form-container">
            ...
            <div class="links-container">
                <p>Not registered yet? <a href="StaffRegistration.aspx">Register here</a></p>
                <p>If you are a manager, please <a href="ManagerLogin.aspx">login here</a></p>
            </div>
        </div>
    </form>
</body>
